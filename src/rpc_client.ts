...
import { AquaMarketAccounts } from './types'
...
export class RPCClient {
    ...
    public async *streamAccountsNotification(accounts: AquaMarketAccounts, marketName: string): AsyncIterable<AccountsNotification> {
        ...
        const accountsChangeNotifications = new AccountsChangeNotifications(accounts, options)
...
// this helper class handles RPC subscriptions to separate DEX accounts
